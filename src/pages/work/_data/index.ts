...
export const chatbooksWorkExperience: WorkExperience = {
  company: 'Chatbooks',
...
export const masterControlWorkExperience: WorkExperience = {
...
export const andrewHolbrookCandidate: Candidate = {
  ...
  workExperience: [chatbooksWorkExperience, slingTvWorkExperience, masterControlWorkExperience],
};
